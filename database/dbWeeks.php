...
function create_dbWeeks() {
    $con=connect();
    mysqli_query($con,"DROP TABLE IF EXISTS dbWeeks");
    $result = mysqli_query($con,"CREATE TABLE dbWeeks (id CHAR(8) NOT NULL, dates TEXT,
 ...
 * @param $id week id --
 * @return week corresponding to id
 */
