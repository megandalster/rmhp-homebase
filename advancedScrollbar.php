...
<html lang="en">
    <head>
        <title>Tiny Scrollbar: A crossbrowser lightweight javascript/jQuery scrollbar.
            Allen downloaded this from: http://baijs.com/tinyscrollbar/
            You can browse there for detailed documentation and examples.
        </title>
        <meta charset="utf-8">
        <meta name="description" content="A crossbrowser lightweight javascript/jQuery scrollbar." />
        <link rel="stylesheet" href="lib/tinyscrollbar.css" type="text/css" />
