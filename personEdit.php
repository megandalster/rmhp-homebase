...
<html>
    <head>
		...
		<script>
			$(function(){
				$( "#birthday" ).datepicker({dateFormat: 'mm-dd-y',changeMonth:true,changeYear:true});
				...
				$( "#screening_status[]" ).datepicker({dateFormat: 'mm-dd-y',changeMonth:true,changeYear:true});
			})
		</script>
    </head>
    <body>
